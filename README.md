...
|[Разработка баззы данных]
(https://github.com/ziga23/data-analysis-projects/blob/main/Проект%20по%20базам%20(1).docx)| В данном проекте я разарабатывал базу данных для приложения, которое используют специалисты в области данных| Завершен|
